...
async def fetch_dynamic(
    ...
    *,
    ...
    timeout:
        Overall timeout in seconds for navigation and wait conditions.
    selector_hints:
        Optional CSS selectors that hint when the page is "ready". The first
        selector that becomes visible will end the wait early.

    Returns
    -------
    tuple
        A tuple containing the final HTML string and a metadata dictionary with
