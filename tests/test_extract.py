...
This module tests the extract module's functionality for extracting
contact information from HTML documents with structured data.
"""
...
def _base_settings(**overrides):
    """Create base settings for extraction tests.
    
    Args:
        **overrides: Settings to override defaults
        
    Returns:
        Dictionary of extraction settings
    """
    settings = {
...
def test_extract_basic_json_ld_contacts():
    """Test extraction of contact information from JSON-LD structured data."""
...
def test_extract_basic_microdata_contacts():
    """Test extraction of contact information from microdata structured data."""
    html = textwrap.dedent(
        """
        <html>
...
def test_extract_basic_structured_toggle():
    """Test that structured data extraction can be toggled on/off."""
    html = """
    <html>
      <head>
